...
//        TABLE_VIEW_BINDINGS.add(new KeyBinding(SPACE, "Activate").ctrl());
    ...
    protected final SizeLimitedList<TablePositionBase> selectionHistory = new SizeLimitedList<>(10);
    ...
    public PrecursorTableViewBehaviorBase(C control) {
        this(control, null);
    }

    public PrecursorTableViewBehaviorBase(C control, List<KeyBinding> bindings) {
